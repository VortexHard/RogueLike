...
def cast_lightning(*args, **kwargs):
    ...
    if target:
        ...
        results.append({'consumed': False, 'target': None, 'message': Message('No entity is close enough to strike.', libtcod.red)})
...
def cast_fireball(*args, **kwargs):
    ...
    if not libtcod.map_is_in_fov(fov_map, target_x, target_y):
        results.append({'consumed': False, 'message': Message('You cannot target a tile outside your FOV.', libtcod.yellow)})
        return results
